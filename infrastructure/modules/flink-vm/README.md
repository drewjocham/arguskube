...
metrics. Used by the KubeWatcher anomaly-detection pipeline.
...
module "flink" {
  ...
  project_id = "kubewatcher-dev-12345"
  region     = "us-west1"
  zone       = "us-west1-a"

  network    = google_compute_network.kubewatcher.name
  subnetwork = google_compute_subnetwork.kubewatcher.name
