...
class ProactiveAgent(BaseAgent):
    """Watches user behaviour, detects working patterns, and pre-computes
    useful information before the user asks for it.

    The goal is to make the system feel *alive* — reporting what it's doing
    in the background ("I noticed you're looking at namespace X, I've pre-fetched
    recent events") — without being in control.
    """
