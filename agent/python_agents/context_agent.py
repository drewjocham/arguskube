...
class ContextAgent(BaseAgent):
    """Manages session context, cross-session memory, and document retrieval.

    The Context Agent is the memory layer — it persists what the user does,
    recalls relevant past context, and indexes documents for RAG.
    Every other agent feeds into it and reads from it.
    """
