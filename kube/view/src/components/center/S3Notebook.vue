      ...
      <div v-if="s3ConfigOpen" class="nb-config-view">
        <div class="config-container">
          <div class="config-header">
            ...
            <p>Connect your Argus notebook to an S3 bucket for persistent markdown storage. Configure S3 credentials in your environment variables (S3_BUCKET, S3_REGION, S3_ACCESS_KEY, S3_SECRET_KEY).</p>
          </div>

          <div class="config-form">
            <div class="form-group">
              <label>S3 Bucket Name</label>
              <input type="text" v-model="s3Config.bucket" class="form-input" placeholder="my-argus-docs" />
            </div>
