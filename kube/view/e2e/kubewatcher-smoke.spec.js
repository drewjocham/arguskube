...
/**
 * P3 E2E Smoke Tests — Argus SRE Console
 *
...
const TITLE = 'Argus — SRE Console'

test.describe('P3 Smoke: Argus view', () => {
  ...
  test('titlebar renders with app name and badge(s)', async ({ page }) => {
    await page.goto('/')
    // Titlebar shows "Argus — SRE Console"
    await expect(page.locator('.titlebar')).toBeVisible()
    await expect(page.locator('.titlebar-title')).toContainText('Argus')
