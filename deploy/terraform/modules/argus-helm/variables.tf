...
variable "namespace" {
  description = "Kubernetes namespace Argus runs in."
  type        = string
  default     = "argus"
}

variable "chart_path" {
  description = "Filesystem path to the parent directory of all Argus Helm charts."
  type        = string
  default     = "${path.module}/../../../deploy/helm"
}
...
# ── Releases ──────────────────────────────────────────────────────
variable "backend_enabled"       { type = bool; default = true }
variable "frontend_enabled"      { type = bool; default = true }
variable "agent_enabled"         { type = bool; default = false }
variable "alert_ingress_enabled" { type = bool; default = false }
variable "mcp_enabled"           { type = bool; default = false }
variable "monitoring_enabled"    { type = bool; default = false }
...
variable "extra_values_backend"        { type = any; default = {} }
variable "extra_values_frontend"       { type = any; default = {} }
variable "extra_values_agent"          { type = any; default = {} }
variable "extra_values_alert_ingress"  { type = any; default = {} }
variable "extra_values_mcp"            { type = any; default = {} }
variable "extra_values_monitoring"     { type = any; default = {} }
